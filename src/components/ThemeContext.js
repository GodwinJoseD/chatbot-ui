...
export function ThemeProvider({ children }) {
  ...
  const t = dark
    ? {
        ...
        sidebarBg: "rgba(27, 28, 29, 0.4)",
        plusiconBg:"#6b686b",
        windowBg: "linear-gradient(112.58deg, rgba(0, 0, 0, 0.8) 0%, rgba(0, 0, 0, 0.3) 100%)",
        windowBorder: "rgba(255,255,255,0.08)",
        cardBg: "rgba(42,44,52,0)",
        ...
        plusIconColor:"rgba(255,255,255,0.92)",
